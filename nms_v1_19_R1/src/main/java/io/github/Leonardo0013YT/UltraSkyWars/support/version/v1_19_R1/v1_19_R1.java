...
package io.github.Leonardo0013YT.UltraSkyWars.support.version.v1_19_R1;
...
public class v1_19_R1 extends NewNMS {
    ...
    public Collection<Integer> spawn(Player p, Location loc, ItemStack head){
        EntityGiantZombie ev = new EntityGiantZombie(EntityTypes.J, (World) loc.getWorld());
        EntityArmorStand ar = new EntityArmorStand(EntityTypes.d, (World) loc.getWorld());
        EntityBat bat = new EntityBat(EntityTypes.g, (World) loc.getWorld());
        ...
        PacketPlayOutSpawnEntity ent = new PacketPlayOutSpawnEntity(ev);
        PacketPlayOutSpawnEntity ent2 = new PacketPlayOutSpawnEntity(ar);
        PacketPlayOutSpawnEntity ent3 = new PacketPlayOutSpawnEntity(bat);
